...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Brand Colors - Professional Network Marketing
        brand: {
          50: '#f0f4ff',
          100: '#e0e9ff',
          200: '#c7d6fe',
      ...
      boxShadow: {
        ...
        'glow-accent': '0 0 40px -10px rgb(16 185 129 / 0.4)',
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(228, 91%, 67%, 0.15) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189, 100%, 56%, 0.1) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(355, 100%, 93%, 0.1) 0px, transparent 50%)',
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
